...
class SmallCNNCifar(nn.Module):
    def __init__(self, args):
        super(SmallCNNCifar, self).__init__()
...
class SmallCNNFmnist(nn.Module):
    def __init__(self, args):
        super(SmallCNNFmnist, self).__init__()
...
class EnhancedCNNFmnist(nn.Module):
    def __init__(self, args):
        super(EnhancedCNNFmnist, self).__init__()
        self.conv1 = nn.Conv2d(1, 32, kernel_size=3, padding=1)
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 32, kernel_size=3, padding=1)
        self.bn2 = nn.BatchNorm2d(32)
        ...
        self.global_fc1 = nn.Linear(128 * 7 * 7, 128)
